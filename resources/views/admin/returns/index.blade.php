                    ...
                    <tbody>
                        @forelse ($restores as $restore)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.returns.edit', $restore) }}" class="btn btn-warning btn-sm">Edit</a>

                                    <form action="{{ route('admin.returns.destroy', $restore) }}" method="POST"
                                        onsubmit="return confirm('Anda yakin ingin menghapus pengembalian ini?')" class="d-inline">
                                        @csrf
                                        @method('DELETE')
