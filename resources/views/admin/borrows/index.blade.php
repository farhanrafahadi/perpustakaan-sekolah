                    ...
                    <tbody>
                        @forelse ($borrows as $borrow)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.borrows.edit', $borrow) }}" class="btn btn-warning btn-sm">Edit</a>

                                    <form action="{{ route('admin.borrows.destroy', $borrow) }}" method="POST"
                                        onsubmit="return confirm('Anda yakin ingin menghapus peminjaman ini?')" class="d-inline">
                                        @csrf
                                        @method('DELETE')
